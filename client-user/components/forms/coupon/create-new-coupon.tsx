...
interface CreateNewCouponProps {
    setOpenDialog: (open: boolean) => void;
}


const CreateNewCoupon: React.FC<CreateNewCouponProps> = ({ setOpenDialog }: CreateNewCouponProps) => {
    ...
    const onSubmit = async (data: CouponFormData) => {
        try {
            ...
            toast.error(error.message || "Đã có lỗi xảy ra khi tạo mã giảm giá! Vui lòng thử lại sau.");
        }
    };
